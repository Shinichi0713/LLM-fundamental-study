...
__確認問題4：Zornの補題による極大イデアルの存在証明__

**問題**  
単位元 1 を持つ可換環 $R$（零環でない）について、Zornの補題を用いて極大イデアルが存在することを示せ。

- ヒント：  
  「$R$ と異なるイデアル全体」の集合に包含関係で半順序を入れ、Zornの補題の条件を確認せよ。

__確認問題5：極大イデアルと剰余体の関係__

**問題**  
可換環 $R$ の極大イデアル $M$ について、次の問いに答えよ。

(1) $R/M$ が体であるとき、任意の $a \notin M$ に対して、ある $b \in R$ が存在して $ab \equiv 1 \pmod{M}$ となることを示せ。  
(2) 逆に、この性質が成り立つならば $M$ は極大イデアルであることを示せ。
...
__問題4__
- $P = \{ I \subset R \mid I \text{はイデアル}, I \neq R \}$ に包含関係で半順序。  
- 任意の鎖の和集合がイデアルであり $R$ でないことを示し、Zornの補題を適用。

__問題5__
- (1) $a+M$ が可逆なので、ある $b$ で $ab \equiv 1 \pmod{M}$。  
- (2) この性質があれば、$M \subsetneq I$ なら $1 \in I$ となり $I=R$。
