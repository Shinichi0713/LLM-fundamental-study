...
def process_markdown_file(input_path: str, output_path: str) -> None:
    ...
    if not input_file.exists():
        ...
        return  # sys.exit ではなく return に変更
...
if __name__ == "__main__":
    ...
    input_md = r"D:\PycharmProjects\LLM-research\LLM-fundamental-study\basics_nn\sets_theory\doc\6_order_set.md"      # 変換前のMarkdownファイル
    output_md = r"D:\PycharmProjects\LLM-research\LLM-fundamental-study\basics_nn\sets_theory\doc\6_order_set_out.md"    # 変換後のMarkdownファイル
