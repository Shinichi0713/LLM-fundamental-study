...
# 実行設定
input_md = r"D:\PycharmProjects\LLM-research\LLM-fundamental-study\llm\doc\18_CARES_acl.md"   # 変換元のファイル名
output_md = r"D:\PycharmProjects\LLM-research\LLM-fundamental-study\llm\doc\18_CARES_acl.md" # 変換後のファイル名
is_note = False
