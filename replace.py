...
# 実行設定
input_md = r"D:\PycharmProjects\LLM-research\LLM-fundamental-study\attention\ssm\karman_filteer\doc\tech.md"   # 変換元のファイル名
output_md = r"D:\PycharmProjects\LLM-research\LLM-fundamental-study\attention\ssm\karman_filteer\doc\tech.md" # 変換後のファイル名
