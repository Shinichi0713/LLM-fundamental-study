...
# 実行設定
input_md = r"D:\PycharmProjects\LLM-research\LLM-fundamental-study\llm\doc\17_Reasoning-in-a-Haystack_Tasks.md"   # 変換元のファイル名
output_md = r"D:\PycharmProjects\LLM-research\LLM-fundamental-study\llm\doc\17_Reasoning-in-a-Haystack_Tasks.md" # 変換後のファイル名
is_note = False
