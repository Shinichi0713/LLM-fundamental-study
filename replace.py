...
# 実行設定
input_md = r"D:\PycharmProjects\LLM-research\LLM-fundamental-study\basics_nn\sets_theory\doc\7_arranged_set.md"   # 変換元のファイル名
output_md = r"D:\PycharmProjects\LLM-research\LLM-fundamental-study\basics_nn\sets_theory\doc\7_arranged_set.md" # 変換後のファイル名
is_note = False
