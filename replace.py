...
# 実行設定
input_md = r"D:\PycharmProjects\LLM-research\other\set_theory\example_transfinite_induction_v2.md"   # 変換元のファイル名
output_md = r"D:\PycharmProjects\LLM-research\other\set_theory\example_transfinite_induction_v2.md" # 変換後のファイル名
is_note = False
