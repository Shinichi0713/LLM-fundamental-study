...
# 実行設定
input_md = r"D:\PycharmProjects\LLM-research\LLM-fundamental-study\attention\ssm\selective_ssm\doc\for_note.md"   # 変換元のファイル名
output_md = r"D:\PycharmProjects\LLM-research\LLM-fundamental-study\attention\ssm\selective_ssm\doc\for_note_converted.md" # 変換後のファイル名
