...
# 実行設定
input_md = r"D:\PycharmProjects\LLM-research\LLM-fundamental-study\attention\ssm\karman_filteer\doc\next_prob_kalman.md"   # 変換元のファイル名
output_md = r"D:\PycharmProjects\LLM-research\LLM-fundamental-study\attention\ssm\karman_filteer\doc\next_prob_kalman_rp.md" # 変換後のファイル名
